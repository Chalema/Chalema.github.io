...
function setMainMenu() {
	...
	if ($("#pauseBtn").replace(/^.*[\\\/]/, '') == "btn_pause.svg") {
		$("#pauseBtn").attr("src","https://chalema.github.io/hextris/images/btn_resume.svg");
	} else {
